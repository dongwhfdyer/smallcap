...
if __name__ == '__main__':
    ...
    parser.add_argument("--k", type=int, default=2, help="Number of retrieved captions to use in prefix")  # todo: whether to use 9 blocks retrieved caps or not. The original param is 4
